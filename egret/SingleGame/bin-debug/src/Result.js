...
var Result = (function (_super) {
    ...
    function Result(data, sex) {
        _super.call(this);
        this.shareMask = new egret.Shape();
        this.txtShare = new egret.TextField();
        this.txtShareDesc = new egret.TextField();
    ...
    Result.prototype.init = function () {
        ...
        WeixinApi.ready(function (api) {
            ...
            var callback = new WeixinShareCallbackInfo();
    ...
    Result.prototype.createView = function () {
        var topMask = new egret.Shape(), bgPerson, imgPerson, txtRank, txtAD, stageW = this.stage.stageWidth, stageH = this.stage.stageHeight, tipsResult, _dp = this.description, _score = this.score, strSex, rank, rankDesc = this.description.rankDesc;
    ...
    Result.prototype.bindEvent = function () {
    ...
    //再玩一次
    Result.prototype.playAgain = function (event) {
        var self = this;
        if (self.playCount === self.description.playLimit) {
            ...
            var selEvent = new SelTypeEvent(SelTypeEvent.PLAYAGAIN);
            selEvent._sex = self.sex;
            self.dispatchEvent(selEvent);
        }
    };
    //分享
    Result.prototype.shareScore = function () {
        var self = this;
    ...
    //抽奖
    Result.prototype.lottery = function () {
        var self = this;
