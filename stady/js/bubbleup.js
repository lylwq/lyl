(function($){
	$.fn.bubbleup = function(settings){
		settings=$.extend({
			tooltip: false,//ÊÇ·ñÌáÊ¾ÎÄ±¾
			scale:120,//·Å´óºóµÄÍ¼Æ¬¿í¶È
			fontFamily:'Helvetica, Arial, sans-serif',//ÌáÊ¾ÎÄ±¾×ÖÌå
			color:'#333333',//ÌáÊ¾ÎÄ±¾×ÖÌåÑÕÉ«
			fontSize:12,//ÌáÊ¾ÎÄ±¾×ÖÌå´óÐ¡
			fontWeight:'bold',//ÌáÊ¾ÎÄ±¾×ÖÌå´ÖÏ¸
			inSpeed:'fast',//Êó±ê»®¹ý·Å´óÊ±µÄËÙ¶È
			outSpeed:'fast'//Êó±êÒÑ³öËõÐ¡Ê±Ê±µÄËÙ¶È
			},settings);
